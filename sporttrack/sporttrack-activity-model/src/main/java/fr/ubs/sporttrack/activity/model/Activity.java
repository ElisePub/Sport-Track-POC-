...
public class Activity {
    ...
    @NotNull
    @Min(value = 0, message = "La distance doit être supérieure ou égale à zéro")
    private int distance;

    @NotNull
    @Min(value = 0, message = "La fréquence minimale doit être supérieure ou égale à zéro")
    private int freqMin;

    @NotNull
    @Min(value = 0, message = "La fréquence maximale doit être supérieure ou égale à zéro")
    private int freqMax;
